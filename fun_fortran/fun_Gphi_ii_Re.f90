double precision function fun_Gphi_ii_Re(kr) result(y)
use myfargs
implicit none
!Input
real*8 kr
!User
complex*16 krho
complex*16 fun_Ve, fun_Vh, fun, fun2
...
!Compute Green
fun_Ve=0.5d0*Zei*( exp(-j*kzi*zzam)+segno*factZe*exp(-j*kzi* (segno*zzp)) )
